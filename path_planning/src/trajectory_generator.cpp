...
ros::Duration planner_delay(0.01);
...
void trajCb(Eigen::MatrixXf coefficients, Eigen::MatrixXf waypoints)
{
	...
	{	
		while(idx < n)
		{
			...
			ros::Duration(0.01).sleep(); //Publish points at 10 Hz
...
int main(int argc, char **argv)
{
	...
	traj_pub = n.advertise<trajectory_msgs::MultiDOFJointTrajectory>("/ardrone/command/trajectory",10);
